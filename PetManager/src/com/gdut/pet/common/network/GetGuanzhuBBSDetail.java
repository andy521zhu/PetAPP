 ...
 * 
 */
public class GetGuanzhuBBSDetail
{

	private static final String TAG = "com.gdut.pet.common.network.GetGuanzhuBBSDetail";

	public GetGuanzhuBBSDetail(
			...
			final FailCallback failCallback, String id)
	{
		...
		new NetConnection(url, HttpMethod.POST, cookieStore,
				...
				}, Configs.ACTION, "testGetGuanzhuBBS",
				//
				"id", id);
	}
