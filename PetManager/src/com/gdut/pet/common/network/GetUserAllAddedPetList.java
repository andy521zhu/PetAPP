 ...
 * 
 */
public class GetUserAllAddedPetList
{

	private static final String TAG = "com.gdut.pet.common.network.GetUserAllAddedPetList";
	 ...
	 *            失败回调
	 */
	public GetUserAllAddedPetList(final String url, final String action,
