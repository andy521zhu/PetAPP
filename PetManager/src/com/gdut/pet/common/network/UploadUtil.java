...
public class UploadUtil
{
	 ...
	 *            请求的URL
	 */
	public void uploadFileMy(final Context mContext, final File file,
			...
			String requestURL, Map<String, String> param)
	{
		...
		try
		{
			...
			// L.i(TAG, "1111111111" + responseCookie);
			conn.setRequestProperty("Cookie", new PersistentCookieStore(
					mContext).getCookie().toString());
			conn.setRequestProperty("Cookie", new PersistentCookieStore(
					mContext).getCookie().toString());
