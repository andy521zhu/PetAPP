...
public class StrayPetList extends ListActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		adapter = new SimpleAdapter(this,getData(MyListData.getStrayPetData()),R.layout.tray_pet_listview,
				new String[]{"masterImage","title","descript","time","pic0","pic1","pic2","pic3","pic4","pic5","pic6","pic7","pic8"},
				new int[]{R.id.trayMasterPic,R.id.trayPetTitle,R.id.trayPetDescript,R.id.trayPetTime
			,R.id.trayPetPic_0,R.id.trayPetPic_1,R.id.trayPetPic_2,R.id.trayPetPic_3,R.id.trayPetPic_4
			,R.id.trayPetPic_5,R.id.trayPetPic_6,R.id.trayPetPic_7,R.id.trayPetPic_8});
		lv=this.getListView();
